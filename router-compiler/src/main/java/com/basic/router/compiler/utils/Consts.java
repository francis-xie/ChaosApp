...
public class Consts {
    ...
    public static final String PACKAGE_OF_GENERATE_FILE = "com.basic.router.routes";
    public static final String PACKAGE_OF_GENERATE_DOCS = "com.basic.router.docs";
    ...
    // Custom interface
    private static final String FACADE_PACKAGE = "com.basic.router.facade";
