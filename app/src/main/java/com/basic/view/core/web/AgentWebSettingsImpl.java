...
package com.basic.view.core.web;
...
public class AgentWebSettingsImpl extends AbsAgentWebSettings {
    ...
    public WebListenerManager setDownloader(WebView webView, DownloadListener downloadListener) {
        ...
        try {
            clazz = Class.forName("com.basic.view.download.DefaultDownloadImpl");
            mDefaultDownloadImpl$Extra =
                    clazz.getDeclaredMethod("create", Activity.class, WebView.class,
                            Class.forName("com.basic.view.download.DownloadListener"),
                            Class.forName("com.basic.view.download.DownloadingListener"),
