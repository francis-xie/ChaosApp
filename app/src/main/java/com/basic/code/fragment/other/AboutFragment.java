...
public class AboutFragment extends BaseFragment {
    ...
    protected void initViews() {
        ...
        XUIGroupListView.newSection(getContext())
                .addItemView(mAboutGroupListView.createItemView(getResources().getString(R.string.about_item_homepage)), v -> Utils.goWeb(getContext(), "https://francis.github.io/XUI/"))
                .addItemView(mAboutGroupListView.createItemView(getResources().getString(R.string.about_item_wiki)), v -> Utils.goWeb(getContext(), "https://github.com/francis/XUI/wiki/"))
                .addItemView(mAboutGroupListView.createItemView(getResources().getString(R.string.about_item_github)), v -> Utils.goWeb(getContext(), "https://github.com/francis/XUI/"))
