...
import com.basic.down.layout.api.DefaultRefreshFooterCreator;
import com.basic.down.layout.api.DefaultRefreshHeaderCreator;
import com.basic.down.layout.api.DefaultRefreshInitializer;
import com.basic.down.layout.api.RefreshContent;
import com.basic.down.layout.api.RefreshFooter;
import com.basic.down.layout.api.RefreshHeader;
import com.basic.down.layout.api.RefreshInternal;
import com.basic.down.layout.api.RefreshKernel;
import com.basic.down.layout.api.RefreshLayout;
import com.basic.down.layout.api.ScrollBoundaryDecider;
import com.basic.down.layout.constant.DimensionStatus;
import com.basic.down.layout.constant.RefreshState;
import com.basic.down.layout.constant.SpinnerStyle;
import com.basic.down.layout.footer.BallPulseFooter;
import com.basic.down.layout.header.BezierRadarHeader;
import com.basic.down.layout.impl.RefreshContentWrapper;
import com.basic.down.layout.impl.RefreshFooterWrapper;
import com.basic.down.layout.impl.RefreshHeaderWrapper;
import com.basic.down.layout.listener.OnLoadMoreListener;
import com.basic.down.layout.listener.OnMultiPurposeListener;
import com.basic.down.layout.listener.OnRefreshListener;
import com.basic.down.layout.listener.OnRefreshLoadMoreListener;
import com.basic.down.layout.listener.OnStateChangedListener;
import com.basic.down.layout.util.DelayedRunnable;
import com.basic.down.layout.util.DensityUtil;
import com.basic.down.layout.util.ViscousFluidInterpolator;
...
import static com.basic.down.layout.util.DensityUtil.dp2px;
import static com.basic.down.layout.util.SmartUtil.fling;
import static com.basic.down.layout.util.SmartUtil.getColor;
import static com.basic.down.layout.util.SmartUtil.isContentView;
...
//    }
     ...
     * Recommended {@link com.basic.down.layout.listener.SimpleMultiPurposeListener}
     * 设置多功能监听器
     * 建议使用 {@link com.basic.down.layout.listener.SimpleMultiPurposeListener}
     ...
     * Recommended {@link com.basic.down.layout.impl.ScrollBoundaryDeciderAdapter}
     * 设置滚动边界判断器
     * 建议使用 {@link com.basic.down.layout.impl.ScrollBoundaryDeciderAdapter}
